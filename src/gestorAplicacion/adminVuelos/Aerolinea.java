...
public class Aerolinea implements Serializable{
	...
	// RECIBE COMO PARAMETRO UN ENTERO, QUE CONTIENE EL ID DEL VUELO A ELIMINAR, Y SE ENCARGA DE RECORRER SU LISTA DE VUELOS PARA ELIMINAR 
	...
	// METODO DE CLASE QUE RECIBE UN ID (INT) Y SE ENCARGA DE BUSCAR ENTRE CADA AEROLINEA Y ENTRE CADA VUELO DE ESTA AEROLINEA, 
	// SI HAY UN TIQUETE ASOCIADO EN LA LISTA DE TIQUETES DE CADA VUELO QUE TENGA POR ID EL QUE LE PASAMOS COMO PARAMETRO Y RETORNAR ESTE TIQUETE, 
